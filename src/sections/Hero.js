    ...
    <section id='hero'>
      <div className='flex flex-col items-center pt-4 mb-4 md:my-16'>
        ...
        <div className='flex flex-col justify-between mb-24'>
          <h1 className='text-b-yellow flex-shrink-0 m-0 mr-8 leading-none md:text-6xl md:mb-4 md:font-light'>Soul-Centered Services</h1>
        ...
        <div className='flex items-center justify-between mb-16 mr-auto'>
          <p className='max-w-3xl py-4 '>
            <h1 className='text-b-yellow m-0 mr-8 leading-none md:text-4xl md:mb-4 md:font-light'>Tutoring</h1>
        ...
        <div className='flex items-center justify-between mb-16 ml-auto'>
          <p className='max-w-3xl p-4 text-right'>
            <h1 className='text-b-yellow m-0 leading-none text-right md:text-4xl md:mb-4 md:font-light'>Nannying</h1>
        ...
        <div className='flex items-center justify-between mb-16 mr-auto'>
          <p className='max-w-3xl py-4 '>
            <h1 className='text-b-yellow m-0 mr-8 leading-none md:text-4xl md:mb-4 md:font-light'>Voice Lessons</h1>
        ...
        <div className='flex items-center justify-between mb-16 ml-auto'>
          <p className='max-w-3xl py-4 text-right '>
            <h1 className='text-b-yellow m-0 leading-none text-right md:text-4xl md:mb-4 md:font-light'>Therapeutic Growth</h1>
